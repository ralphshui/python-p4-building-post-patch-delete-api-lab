...
def baked_goods_delete(id):
    ...
    response_body = {"message": "Baked good Deleted!!"}

    response = make_response(response_body, 200) #or can jsonify("Baked good Deleted!!") the string directly instead of adding a reponse_body
